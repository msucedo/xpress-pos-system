...
const Dashboard = () => {
  ...
  const stats = [
    { icon: <Icon name="expense" size={32} />, label: 'Para Entregar', value: (orders.enEntrega?.length || 0).toString(), type: 'entregas' },
    ...
    { icon: <Icon name="split-transaction" size={32} />, label: 'Ingresos Hoy', value: `$${todayIncome}`, type: 'ingresos' },
    ...
    { icon: <Icon name="open-box" size={32} />, label: 'Total Órdenes Activas', value: totalActiveOrders.toString(), type: 'activas' },
  ...
  return (
    <div className="dashboard">
      ...
      <div className="priority-section">
        ...
        <div className="task-group">
          <div className="task-group-header">
            <div className="task-group-icon entregas"><Icon name="calendar" size={24} /></div>
            <div className="task-group-title-wrapper">
