    ...
    -[]ir tab por tab validando iconos y corrigiendo UX
        -[FIX]wip tab ordenes
            ...
            -[FIX]validar version movil de tab ordenes
                -[FIX]1.DONE-definir padding en tab orders para movil. 2-agregar X en el header, en orderformmobile al estilo de orderdetailview. 3.DONE-arreglar la seccion en orderdetailview de informacion de pago y de entrega para moviles sale cortada. 4-acomodar header de version movil orderdetailview
